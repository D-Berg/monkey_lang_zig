/// Copied from ziglang/zig/src/trace.zig
...
pub const callstack_depth = 10; //if (enable_callstack and build_options.tracy_callstack_depth > 0) build_options.tracy_callstack_depth else 10;
